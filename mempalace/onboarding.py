...
def _generate_critical_facts_bootstrap(
    people: list, projects: list, wings: list, mode: str, config_dir: Path = None
):
    """
    Generate critical facts bootstrap from onboarding data.
    Teaches the AI about the user's world from session one.
    """
...
""")
    ...
    # Generate critical facts bootstrap
    _generate_critical_facts_bootstrap(people, projects, wings, mode, config_dir)
